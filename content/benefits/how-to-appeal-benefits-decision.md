...
**Do not miss the one-month deadline.** The DWP can accept late requests but only if there is "special circumstances" for the delay, such as serious illness. If you are approaching the deadline and haven't written yet, send a short letter today asking for reconsideration, even if your full evidence isn't ready yet. You can follow up with more detail afterwards.
:::
...
:::callout{type="warning"}
**Tick the right hearing option.** The SSCS1 form asks whether you want a paper hearing (decided on documents alone) or an oral hearing (where you attend or join by video). Statistics consistently show that oral hearings succeed at a much higher rate. Unless your health genuinely prevents you attending, choose an oral hearing.
:::
