---
title: How to claim Pension Credit
description: >-
...
howTo:
  totalTime: PT45M
  steps:
    - name: Check whether you're likely to qualify
      text: >-
        Use the Pension Credit calculator on GOV.UK to get a rough figure before
        you apply.
    - name: Gather your documents and information
      text: >-
        Collect your National Insurance number, bank account details, and
        information about any income, savings or housing costs before you start.
    - name: Choose how to apply
      text: >-
        Decide whether to apply online, by phone, or by post, depending on what
        suits you.
    - name: Complete the application
      text: >-
        Work through the GOV.UK form or phone application, answering questions
        about your income, savings, and living situation.
    - name: Submit and note your claim date
      text: >-
        Submit your application and record the exact date, because Pension
        Credit can be backdated by up to three months from that point.
    - name: Wait for your award notice and check it
      text: >-
...
:::callout{type="warning"}
Pension Credit must be renewed or reported if your circumstances change: if a partner moves in or out, if your income increases, or if your savings go above a threshold. Failing to report changes can result in an overpayment, which the DWP will recover. If anything in your life changes, call the helpline.
:::
