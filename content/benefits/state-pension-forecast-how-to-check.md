---
title: How to check your State Pension forecast on gov.uk
description: >-
  A step-by-step guide to using the Check Your State Pension tool on gov.uk,
...
howTo:
  totalTime: PT20M
  steps:
    - name: Gather what you need before you start
      text: >-
        Collect your National Insurance number, a form of photo ID, and your
        bank details if you've not set up a Government Gateway account before.
    - name: Go to the Check Your State Pension tool
      text: >-
        Visit gov.uk and search for 'Check your State Pension forecast', then
        select the official service result.
    - name: Sign in or create a Government Gateway account
      text: >-
        Use an existing Government Gateway ID and password, or register for a
        new account using your National Insurance number and ID documents.
    - name: Verify your identity
      text: >-
        Complete the identity check, which may ask you to confirm details from
        your passport, driving licence, or a recent payslip.
    - name: Read your forecast
      text: >-
        Review the weekly and annual figures shown for your State Pension, your
        current qualifying years, and how many more you could add.
    - name: Check whether voluntary contributions could help
      text: >-
...
If you can't find your National Insurance number, don't guess it. You can ask HMRC to confirm it by calling 0300 200 3500 (Monday to Friday, 8am to 6pm). Getting it wrong in the verification step will lock you out temporarily.
:::
...
:::callout{type="warning"}
The forecast is based on current legislation. If you have more than 35 qualifying years already, the tool may show that you can't increase your State Pension further by working longer. That's not an error. The new State Pension is capped at the full rate, and extra working years beyond 35 don't add to it unless you have a shortfall from a previous contracted-out pension arrangement. If contracted-out periods apply to you, the calculation is more complicated and worth a call to the Future Pension Centre on 0800 731 0175.
:::
...
:::callout{type="info"}
Age UK has a free helpline (0800 678 1602) staffed by advisers who can help you understand your forecast if you're unsure what you're looking at. They won't give regulated financial advice, but they can explain the basics in plain English and point you towards the right next step.
:::

---

:::faq
## Questions people ask after checking their forecast
