...
howTo:
  totalTime: PT20M
  steps:
    - name: Check you're eligible
      text: >-
        Confirm you've reached State Pension age, currently 66, and live in
        England.
    - name: Gather your documents
      text: >-
        Collect proof of age and proof of address before you start the
        application.
    - name: Find your local council's application page
      text: >-
        Go to GOV.UK and use the postcode tool to reach your council's
        concessionary travel page.
    - name: Complete the application
      text: >-
        Fill in the online form, or request a paper form if you'd prefer, and
        upload or post your documents.
    - name: Wait for your pass to arrive
      text: Allow up to four weeks for the pass to be processed and posted to you.
    - name: Activate and use your pass
      text: >-
...
Don't send original documents in the post. If the council asks for paper copies, send photocopies. Originals get lost more often than anyone likes to admit, and replacing a birth certificate is a significant hassle.
:::
...
:::callout{type="warning"}
The pass does not cover express coaches (National Express, Megabus and similar), rail services, or trams. It applies to local bus services only. Some councils offer additional local concessions on top of the national scheme, worth checking.
:::
