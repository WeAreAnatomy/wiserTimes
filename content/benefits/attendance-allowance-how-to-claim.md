---
title: How do you claim Attendance Allowance step by step?
description: >-
  A plain-English walkthrough of the Attendance Allowance claim process, from
  getting the form to what happens after you post it.
slug: attendance-allowance-how-to-claim
keywords:
...
howTo:
  totalTime: PT2H
  steps:
    - name: Check you meet the basic eligibility criteria
      text: >-
        Confirm you are 65 or over, living in Great Britain, and have needed
        help with personal care or supervision for at least six months.
    - name: Get the AA1 claim form
      text: >-
    ...
    - name: Gather supporting evidence
      text: >-
        Collect letters, prescriptions or a GP summary that backs up what you
        have written on the form.
    - name: Post the form and note the date
      text: >-
        Send the completed form to the Attendance Allowance Unit and keep a
        copy, noting the posting date for backdating purposes.
    - name: Wait for the decision and respond if needed
      text: >-
        A decision letter usually arrives within 40 working days; contact the
...
:::callout{type="warning"}
**Don't leave boxes blank to seem modest.** A blank box looks like "no need" to a DWP decision maker. If a question doesn't apply to you, write "N/A" or "no difficulty here." If it does apply, write something, however brief.
:::
...
:::callout{type="warning"}
**The three-month backdating rule.** If you were eligible for Attendance Allowance but didn't claim for a period because you didn't know you could, the DWP will not normally backdate your award beyond the date they received your form. There is a narrow exception for people who were wrongly advised by the DWP itself. The practical message: claim as soon as you think you might qualify.
:::
