...
howTo:
  totalTime: PT90D
  steps:
    - name: Contact your local authority housing department
      text: >-
        Phone or email your council's housing or adult social care team to
        register your interest in a Disabled Facilities Grant.
    - name: Arrange an occupational therapist assessment
      text: >-
        A council OT will visit your home and assess which adaptations are
        necessary and appropriate for your needs.
    - name: Receive the OT recommendation and schedule of works
      text: >-
        The OT produces a report specifying the adaptations; this forms the
        basis of your grant application.
    - name: Complete the formal grant application
      text: >-
        Submit the application form, along with two contractor quotes for the
        work, to your council's housing team.
    - name: Undergo the means test
      text: >-
        The council calculates how much you are expected to contribute, based on
        your income and savings, using the standard DFG means test.
    - name: Get approval and appoint a contractor
      text: >-
        Once the council approves the grant, you appoint an approved contractor
        and the works are scheduled.
    - name: Works completed and grant paid
      text: >-
...
---
This guide is for anyone in England living with a disability or long-term condition who needs adaptations to their home, and for family members researching the process on their behalf. By the end you'll know exactly how the Disabled Facilities Grant works, what the council will and won't fund, how the means test is calculated, and what to do if your application is refused or delayed.
...
GOV.UK's [Find your local council](https://www.gov.uk/find-local-council) tool will give you the right number in thirty seconds. When you call, say you're enquiring about a Disabled Facilities Grant and would like to request an occupational therapist assessment. You don't need to have a diagnosis letter to hand at this stage.

:::callout{type="warning"}
Don't commission any work before your application is approved. If you start adaptations before the grant is agreed, the council can refuse to fund them, even if the work is exactly what they would have recommended.
:::
...
Money Helper has a [DFG means test calculator](https://www.moneyhelper.org.uk) that gives a rough indication of expected contributions before you apply. I'd suggest using it early so you're not surprised later.
...
:::callout{type="warning"}
The grant approval is usually time-limited, often to twelve months for completion of works. If your contractor causes delays or the works overrun, contact your council's housing team before the deadline, not after, to ask for an extension. Extensions are commonly granted but must be requested in advance.
:::
