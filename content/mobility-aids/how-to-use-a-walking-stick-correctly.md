---
title: How to use a walking stick safely and correctly
description: >-
  An occupational therapist explains how to hold a walking stick, set the right
  height, use stairs, and choose the right type for your needs.
slug: how-to-use-a-walking-stick-correctly
...
howTo:
  totalTime: PT20M
  steps:
    - name: Set the correct height
      text: >-
        Adjust your stick so the handle sits level with your wrist crease when
        you're standing upright with your arm relaxed.
    - name: Hold it in the correct hand
      text: Hold the stick in the hand opposite to your weaker or painful leg.
    - name: Find your walking rhythm
      text: >-
        Move the stick and your affected leg forward at the same time, then step
        through with your stronger leg.
    - name: Go up stairs safely
      text: >-
        Lead with your stronger leg going up, keeping the stick on the step
        below.
    - name: Go down stairs safely
      text: >-
        Lead with the stick and your weaker leg going down, letting your
        stronger leg follow.
    - name: Choose the right stick type
      text: >-
...
A common mistake is adjusting height while wearing slippers, then using the stick in outdoor shoes with a heel. Even a small heel raises you by a centimetre or two. Always check height in the footwear you'll actually be wearing.
:::
...
:::callout{type="warning"}
Stairs are where most stick-related falls happen, usually because people rush, skip a step in the sequence, or use a stick with a worn ferrule (the rubber tip at the bottom). Check your ferrule regularly. A flat or cracked ferrule on a hard floor offers almost no grip. Replacements cost under £2 from most pharmacies and are worth replacing every few months if you use the stick daily.
:::
