...
howTo:
  totalTime: PT60M
  steps:
    - name: Check whether you qualify
      text: >-
        Understand who is entitled to a social care needs assessment under the
        Care Act 2014.
    - name: Contact your local council
      text: >-
        Call or email your council's adult social care team to formally request
        an assessment.
    - name: Prepare for the assessment visit
      text: >-
        Gather relevant information about your daily life, health conditions and
        current support arrangements.
    - name: Take part in the assessment
      text: >-
        Work through the assessment with the assessor, describing honestly what
        you find difficult.
    - name: Receive and review your care and support plan
      text: >-
...
Some people are told by council phone staff that they "probably won't qualify" before they've even had an assessment. That is not a lawful refusal. Under the Care Act, councils must carry out an assessment if you appear to have needs. If you're turned away at the point of enquiry, ask for the refusal in writing and contact your local Age UK for support.
:::
...
:::callout{type="warning"}
If the assessor suggests solutions before the assessment is finished (for example, "we'll probably just send in a carer twice a week"), don't let that close down the conversation. Everything should still go into the formal assessment record. You can add to it, and you can request changes to the draft before it's finalised.
:::
