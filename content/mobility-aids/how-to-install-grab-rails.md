...
howTo:
  totalTime: PT3H
  steps:
    - name: Decide who should fit the rails
      text: >-
        Assess whether this is a DIY job or one for a handyperson or OT-led
        installation service.
    - name: Get an OT assessment if you're unsure where rails should go
      text: >-
        Contact your local authority to request a free occupational therapist
        home visit before buying anything.
    - name: Choose the right rail for the location
      text: >-
        Match rail type (straight, angled, fold-down) and length to the specific
        transfer or movement it needs to support.
    - name: Find the wall studs or use the correct fixings for your wall type
      text: >-
        Locate timber noggins with a stud finder, or select specialist
        hollow-wall or solid-wall anchors as appropriate.
    - name: Mark and drill the fixing positions
      text: >-
        Hold the rail in position at the correct height, mark each fixing hole,
        then drill to the right depth for your wall type.
    - name: Fix the rail and test it properly
      text: >-
...
**Don't let a general builder quote you for a "bathroom safety job" without asking specifically about grab rail load ratings and fixing methods.** General builders often underspecify fixings. A grab rail that pulls out of the wall during a transfer causes a fall far worse than the one it was meant to prevent. Ask for fixings rated to at least 150 kg per fixing point, and get that in writing.
:::
...
:::callout{type="warning"}
**Don't tile over or silicone-seal around the base of the rail flanges.** It looks neater but it traps moisture, rots the fixings faster, and makes it impossible to check or tighten the screws later. The flanges should remain accessible.
:::
