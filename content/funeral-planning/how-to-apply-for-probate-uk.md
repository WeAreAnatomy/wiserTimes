---
title: How to apply for probate in England and Wales
...
description: >-
  ...
  when you need it, how to apply online via HMCTS, what it costs, and how long
  it takes.
...
howTo:
  totalTime: PT3H
  steps:
    - name: Check whether probate is actually needed
      text: >-
        Confirm the estate's assets and structure to establish whether a grant
        of probate is legally required before you start.
    - name: Gather the documents you will need
      text: >-
        Collect the original will, the death certificate, and the details of all
        assets and liabilities in the estate.
    - name: Value the estate
      text: >-
        Calculate the total value of all assets and debts to determine whether
        Inheritance Tax is due and complete form IHT205 or IHT400 accordingly.
    - name: Report to HMRC if Inheritance Tax applies
      text: >-
        Submit the relevant Inheritance Tax return to HMRC and, if tax is owed,
        arrange payment before applying for probate.
    - name: Register and apply via HMCTS Probate Service
      text: >-
        Create an account on the HMCTS online probate service and submit your
        application, uploading the will and supporting documents.
    - name: Pay the probate fee
      text: >-
        Pay the court fee online as part of your application; exemptions apply
        for smaller estates.
    - name: Send in original documents
      text: >-
        Post the original will and death certificate to the probate registry as
        instructed after submitting your online application.
    - name: Receive the grant and begin administering the estate
      text: >-
...
Do not begin distributing any assets until you have confirmed the position on Inheritance Tax. Executors can be held personally liable for tax underpaid because funds were released too early.
:::
...
:::callout{type="warning"}
Inheritance Tax thresholds include the residence nil-rate band, transferable allowances from a deceased spouse, and several reliefs for business and agricultural property. Getting this wrong costs real money. If the estate is at all close to the threshold, speak to a solicitor or tax adviser before filing.
:::
...
1. Confirm your role (executor named in the will, or administrator if there is no will)
2. Enter the deceased's details, the date of death, and their permanent address
3. Confirm whether there is a will and whether it has any codicils (amendments added after the original will was signed)
4. Enter the gross and net estate values you calculated in Step 3
5. Confirm the IHT position and, if applicable, enter your IHT reference number
...
:::callout{type="warning"}
If there are multiple executors named in the will, all of them can apply together or one can apply with the others "power reserved" to them, meaning they could step in later if needed. Get agreement between executors before you start the online form; changing this partway through causes delays.
:::
