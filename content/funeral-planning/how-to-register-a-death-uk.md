...
**Don't assume the MCCD will arrive automatically.** Hospitals sometimes assume the family will call to collect it. GP surgeries may not realise a patient has died unless you tell them. Make the call yourself, and ask explicitly whether the MCCD is ready and how to collect it.
:::
...
If someone died in a hospital in Manchester but lived in Leeds, you register in Manchester. The GOV.UK register office finder at [gov.uk/register-offices](https://www.gov.uk/register-offices) lets you search by town or postcode. Most offices require appointments; walk-ins are rare now. Call or book online.
...
:::callout{type="warning"}
**Check the spelling of every name before you confirm.** A misspelt name on the death certificate can cause problems later when dealing with banks, pension providers or solicitors handling an estate. The registrar will ask you to confirm the entry is correct before it's signed off.
:::
