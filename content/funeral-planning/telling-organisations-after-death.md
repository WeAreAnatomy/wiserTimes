---
title: 'Who to notify when someone dies: a complete checklist'
description: >-
  A step-by-step guide to telling government departments, banks, pension
  providers and utilities after a bereavement. Includes the Tell Us Once
  service.
...
howTo:
  ...
  steps:
    - name: Register the death
      text: >-
        Get the death certificate from the register office before contacting any
        organisation.
    - name: Use Tell Us Once
      text: >-
        Notify multiple government departments in a single session through the
        Tell Us Once service.
    - name: Contact the DWP and pension providers
      text: >-
        Stop state pension and benefit payments and notify any private or
        workplace pension providers.
    - name: Notify banks and financial institutions
      text: >-
        Freeze or transfer accounts, cancel direct debits and arrange access to
        funds for the estate.
    - name: Inform HMRC
      text: >-
        Report the death for tax purposes and request a tax calculation if one
        is needed.
    - name: Contact the DVLA
      text: >-
        Return the driving licence and notify the DVLA if there is a vehicle to
        transfer or take off the road.
    - name: 'Tell utilities, subscriptions and insurers'
      text: >-
        Work through household accounts, cancel subscriptions and update or
        cancel insurance policies.
    - name: Notify professional and personal contacts
      text: >-
...
Do not rely on photocopies or scanned PDFs. Most financial institutions and government bodies will only accept a certified original. Sending a photocopy will delay your request and means chasing it up weeks later when you have other things on your mind.
:::
...
The service is available at [gov.uk/after-a-death/organisations-you-need-to-contact-and-tell-us-once](https://www.gov.uk/after-a-death/organisations-you-need-to-contact-and-tell-us-once) or by calling 0800 085 7308. You have 28 days from registration to use the reference number.
