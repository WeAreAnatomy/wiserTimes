...
:::callout
**Your right to itemise**

You do not have to buy a package. The CMA rules also require funeral directors to price individual services separately, so you can, for example, instruct a firm to handle collection, storage and paperwork only, then arrange the ceremony yourself. Not all firms will encourage this, but all covered by the rules must offer it.
:::
