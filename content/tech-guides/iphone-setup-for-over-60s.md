...
howTo:
  totalTime: PT60M
  steps:
    - name: Adjust the display so it's comfortable to read
      text: >-
        Increase the text size and turn on Display Zoom before you do anything
        else.
    - name: Set up Face ID or a passcode
      text: >-
        Secure the phone with Face ID or a six-digit passcode so your data is
        protected.
    ...
    - name: Turn on iCloud backup
      text: >-
        Switch on automatic iCloud backup so your photos and contacts are saved
        even if the phone is lost or broken.
    - name: Learn your way around the basic controls
      text: >-
        Spend a few minutes getting comfortable with the home screen, the side
...
:::callout{type="warning"}
**On the Apple ID password:** Apple requires a fairly strong password (a mix of upper and lower case letters, a number, and a symbol). Write it down in a safe place the moment you create it. Losing access to your Apple ID is a real headache, and the recovery process involves verification codes sent to devices or phone numbers you may no longer have. Keep a written record somewhere secure at home.
:::
