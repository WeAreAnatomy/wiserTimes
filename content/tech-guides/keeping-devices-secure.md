---
title: 'How to keep your phone, tablet and computer secure'
description: >-
  Practical security tips for phones, tablets and computers in the UK. Learn
  about updates, antivirus, suspicious links and what to do if something goes
  wrong.
...
faqs:
  ...
  - q: What should I do if I think I've been scammed online?
    a: >-
      Stop all contact with the scammer, do not send any more money, and report
      it to Action Fraud on 0300 123 2040 or via actionfraud.police.uk. If bank
      details were involved, call your bank's fraud line immediately using the
      number on the back of your card.
  - q: Is public Wi-Fi safe to use for banking?
    a: >-
      No. Avoid logging into your bank or any account that holds financial or
      personal data on public Wi-Fi, such as in a café or library. Use your
      mobile data connection instead, or wait until you're on a trusted home
      network.
...
Criminals don't need to break into your house to steal from you. They do it through your phone, tablet or laptop, usually by tricking you rather than hacking you in any dramatic sense.
...
Updates are probably the single most effective thing you can do to stay secure. This is worth saying plainly, because many people tap "remind me later" for months and then wonder why.

When security researchers or even criminals discover a weakness in an operating system or app, the software company releases a fix. That fix is the update. Until you install it, your device has a known vulnerability that criminals can potentially use.
...
Antivirus software scans files, downloads and websites for known malicious code. Think of it as a filter that checks things before they reach the part of your device where they could cause harm.

On Windows PCs, you almost certainly already have something running. Windows Defender (built into Windows 10 and 11) is free, automatic and genuinely good. You don't need to buy anything on top of it, though paid options like Malwarebytes Premium or Norton 360 offer additional features such as a VPN or identity monitoring if you want them.
...
This is where most attacks actually begin. Not with sophisticated hacking, but with a convincing message and a click.
...
When in doubt, don't click the link. Go directly to the organisation's official website by typing the address yourself, or call them on a number you find independently, not one given in the message.

:::callout
**Forward suspicious texts to 7726.** The National Cyber Security Centre (NCSC) runs a free service where you can forward suspicious text messages to 7726 (which spells SPAM on a keypad). For suspicious emails, forward them to report@phishing.gov.uk. Both are run by the UK government and help take down fraudulent sites.
:::

## Safe habits for day-to-day browsing

Most safe browsing is habit rather than technical configuration. A few things that make a real difference:
...
Avoid saving your card details on websites you use rarely. Storing them with a major retailer like Amazon or John Lewis is low-risk; storing them on a small website you've used once is less so.

## What to do if something goes wrong

If you think your device has been compromised, or you've clicked something you shouldn't have, try not to panic. The steps below apply to most situations.

First, disconnect from the internet. If you're on Wi-Fi, turn Wi-Fi off. This can stop malicious software communicating outwards or downloading further harmful files.
...
Report the incident to Action Fraud, the UK's national fraud reporting centre, at actionfraud.police.uk or by phone on 0300 123 2040. You won't necessarily get a personal investigation, but reports do feed into broader police intelligence and help identify patterns.

If you're not sure what's happened and you have an Apple device, both Apple Support (apple.com/uk/support) and the Microsoft Answer Desk (in Microsoft stores and online) offer paid and sometimes free help. Many local libraries also run free digital skills sessions; Age UK runs its Digital Champions programme specifically for people who want one-to-one guidance.

## A note on keeping things in perspective

The goal of all of this isn't to make you frightened of your phone. Millions of people in the UK use devices safely every day without thinking too much about any of this, largely because the basic habits become second nature quickly.

If you want a place to start, the NCSC's Cyber Aware campaign (ncsc.gov.uk/cyberaware) has a short checklist covering the highest-impact actions. You can complete it in about ten minutes and it covers everything from password strength to backing up your photos.

For a broader look at technology for later life, our [technology guides hub](/tech-guides/) covers everything from setting up a new tablet to making video calls with grandchildren.
