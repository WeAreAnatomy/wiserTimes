...
:::callout{type="tip" title="Add your family to Contacts first"}
It is far quicker to call someone if their name is in the Contacts app. Open Contacts, tap the plus sign, and add at least their name and either a phone number or an email address linked to their Apple ID.
:::
...
:::proscons{title="Pros and cons of the link method"}
pros:
- Works with almost anyone, on any phone or computer
- No need for the other person to install an app
- You can schedule the link ahead of time and send it by email
cons:
- The other person has to click the link when the call starts
- The picture quality can be slightly lower on non-Apple devices
