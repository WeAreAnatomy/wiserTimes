---
title: How to make a complaint about an equity release product or adviser
description: >-
  A step-by-step guide to complaining about an equity release product or adviser
...
howTo:
  totalTime: PT30M
  steps:
    - name: Identify who your complaint is against
      text: >-
        Establish whether your complaint is about the product itself, the
        lender, or the adviser who sold it to you.
    - name: Gather your documents
      text: >-
        Collect your original mortgage illustration, suitability letter, offer
        document, and any written communications.
    - name: Submit your complaint in writing to the firm
      text: >-
        Write to the firm's dedicated complaints department, stating what went
        wrong and what outcome you want.
    - name: Wait for the firm's final response
      text: >-
        The firm has eight weeks to issue a final response letter; note the date
        you submitted so you can track this.
    - name: Refer to the Financial Ombudsman Service if needed
      text: >-
        If you're unhappy with the final response, or eight weeks pass without
        one, refer the case to the Financial Ombudsman Service within six
        months.
    - name: Engage with the Ombudsman's process
      text: >-
...
**Don't pay a claims management company to do this for you.** A number of firms advertise heavily to equity release customers, promising to handle the complaint on a "no win, no fee" basis. That fee is typically 20% to 30% of any compensation awarded. The process described in this guide is something you can do yourself. The Financial Ombudsman Service is free.
:::
...
:::callout{type="warning"}
**Check the time limit carefully if your product is older.** The FOS generally considers complaints about events that occurred within six years, or within three years of when you could reasonably have known something was wrong. Equity release is a long-term product, and some mis-selling cases only become apparent years after completion. If you're unsure whether your complaint falls within the time limits, contact FOS directly before assuming you're out of time.
:::
