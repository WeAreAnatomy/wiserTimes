---
title: 'Lifetime mortgage vs home reversion: which suits you?'
description: >-
  Lifetime mortgages and home reversion plans both release equity from your
  home, but they work very differently. Here's what each one actually does.
...
faqs:
  - q: 'Which is more popular, a lifetime mortgage or a home reversion plan?'
    a: >-
      Lifetime mortgages account for the vast majority of equity release in the
      UK. According to the Equity Release Council, they make up well over 95% of
      all plans taken out. Home reversion plans exist but are offered by a much
      smaller number of providers.
  - q: Can I still leave an inheritance with either type of plan?
    a: >-
      With a lifetime mortgage, you can ring-fence a percentage of your
      property's future value as a protected inheritance guarantee. With home
      reversion, you sell a share of the property outright, so only the portion
      you retain will pass to your estate.
  - q: What happens if my property falls in value after I take out a plan?
    a: >-
      Both types carry a no negative equity guarantee under Equity Release
      Council standards. You or your estate will never owe more than the
      property sells for, regardless of how much is outstanding.
  - q: Is there a minimum age for either product?
    a: >-
      Most lifetime mortgage lenders require you to be at least 55. Home
      reversion providers typically set their minimum at 65, sometimes 60,
      because the discount applied to the valuation is lower for older
      applicants.
  - q: Do I need separate legal advice?
    a: >-
      Yes. Both products require you to take independent legal advice before
      completion. This is a condition of Equity Release Council membership, not
      just good practice.
affiliates: []
---
...
This article covers how each product is structured, what the costs look like in real numbers, and the situations in which one tends to be considered over the other. For a broader overview of how equity release works, the [equity release pillar guide](/equity-release/) is the right place to start.
...
:::callout
**Worth knowing before you go any further:** home reversion plans are offered by far fewer providers than lifetime mortgages. In practice, the main UK reversion provider is Bridgewater Equity Release (part of the Just Group). An independent adviser can tell you what is currently available given your age, property value and location.
:::
...
**Example:** £100,000 released at age 68, fixed rate of 6.5%, no voluntary repayments made.
...
:::callout
**Get regulated advice.** Both lifetime mortgages and home reversion plans are regulated by the FCA. You must receive formal regulated advice from an FCA-authorised adviser before taking out either product. A fee may be charged for this advice; ask upfront what it is. Key Later Life Finance, Age Partnership and Responsible Equity Release are among the advisers who operate across the full market, though there are others.
:::
