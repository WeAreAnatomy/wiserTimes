---
title: How to write a will in the UK
...
description: >-
  ...
  to sign it correctly, and where to get help if your situation is complicated.
howTo:
  totalTime: PT2H
  steps:
    - name: Decide what you own and who should have it
      text: >-
        List your assets and debts so you know the size of your estate before
        you start.
    - name: Choose your executors
      text: >-
        Appoint one or two people you trust to carry out your wishes after you
        die.
    - name: Decide on guardians for any children under 18
      text: Name a guardian in the will if you have dependent children.
    - name: Write the will
      text: >-
    ...
    - name: Sign it correctly in front of two witnesses
      text: >-
        ...
        must then sign in your presence.
    - name: Store the will safely
      text: >-
        Keep the original somewhere fireproof and accessible, and tell your
        executors where it is.
tags:
  - wills
  - later-life planning
  - legal
...
If you're married or in a civil partnership and you die without a will, intestacy rules don't automatically leave everything to your spouse. If your estate exceeds £322,000 (as of 2025, per GOV.UK), your children inherit a share. Many people are surprised by this. A will is the only way to control it.
:::
...
:::callout{type="warning"}
Video witnessing was temporarily permitted during the Covid pandemic but that provision has ended. As of 2025, both witnesses must be physically present with you in the same room when you sign. Remote witnessing via video call is no longer valid in England and Wales.
:::
