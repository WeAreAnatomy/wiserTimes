---
title: What happens to your online accounts when you die?
description: >-
  Your emails, social media and subscriptions don't disappear when you die.
  Here's what UK law says and the practical steps to take now.
...
keywords:
  ...
  - facebook after death uk
  - digital estate planning
  - password inheritance uk
faqs:
  ...
  - q: What happens to my Netflix or Spotify subscription when I die?
    a: >-
      The subscription continues billing until someone cancels it. These
      accounts cannot legally be inherited; they are licences, not assets. Your
      executor should cancel them promptly to avoid wasted payments from the
      estate.
  ...
  - q: Can I leave my iTunes or Kindle library to someone?
    a: >-
      ...
      to your account, not property you own outright. They cannot be transferred
      or inherited under current terms of service.
  - q: Does Facebook delete accounts automatically after death?
    a: >-
      No. Without action, a Facebook account simply remains. A nominated legacy
...
The legal position in the UK is not as settled as most people assume. There is no single piece of legislation dealing with digital assets after death. Ownership depends on the terms of service for each platform, and those terms vary considerably. In most cases, what you "own" is a licence to use a service, not a transferable asset in the legal sense. That matters when you try to leave it to someone.
...
**X (formerly Twitter)** does not memorialise. A verified family member or authorised person can request permanent deactivation by providing proof of death and their relationship to the deceased. There is no option to preserve the account in any active way.

**LinkedIn** will remove a profile on request from a family member or colleague. It does not offer a memorialisation option.

The gap between what people want and what platforms allow is real. If those years of posts, photos and memories matter to you or your family, the time to record your preferences is now, not after the fact.

## Can your family access your email and files?
...
Microsoft's approach is less generous. There is no formal legacy contact system. Family members can request account closure and, in some circumstances, a copy of the data, but access to the live account is not typically granted.

For any of these, your family will need at minimum a death certificate. In practice, many executors find that even with a death certificate and months of correspondence, some providers simply will not grant access. Having login details written down somewhere secure is often the most pragmatic answer.
...
A simple list of your subscriptions, where they bill and roughly what they cost, kept with your will or in a secure document, will save your executor real time and money.

Cryptocurrency is a different matter entirely. If you hold Bitcoin, Ethereum or any other digital currency, those assets can have significant financial value and will form part of your estate. But they are only accessible with the private key or seed phrase. Lose those, and the funds are gone permanently. There is no customer service team to call. If you hold crypto, specialist advice on secure storage and inheritance planning is not optional.

## How should you record passwords safely?
...
Your existing will may not mention digital assets at all. That is not unusual; most older wills don't. You don't necessarily need to rewrite it, but you should talk to your solicitor about adding a clause that covers digital property and gives your executor explicit authority to deal with online accounts.

More immediately useful is a **digital legacy letter** or **digital asset memorandum** kept alongside your will. This is an informal document (it doesn't need a solicitor) that sets out your accounts, your wishes for each one, and where relevant credentials can be found. It should be reviewed every year or so, since accounts come and go.

Age UK has useful general guidance on estate planning, and the Law Society can help you find a solicitor experienced in this area. For a broader grounding in wills and lasting power of attorney, our [guide to wills and estate planning](/wills-poa/) covers the full picture.

## Practical steps to take this week

You don't need to do everything at once. Four concrete steps will put you well ahead of most people:

1. Check your Google and Apple account settings and set up Inactive Account Manager or Digital Legacy contacts today. Both are free and take minutes.
2. Write a list of your active subscriptions, what they cost and how they bill. Keep it with your important documents.
3. Decide what you want to happen to your Facebook account and record your preference, either in your account settings or in a written note. Tell someone.
4. If you use a password manager, investigate emergency access options. If you don't, consider whether a sealed envelope at your solicitor is the right fallback.

None of this is morbid. It is the same practical thinking that goes into writing a will or arranging a funeral plan. The people who will deal with your estate deserve to find things in order.

:::callout
**Don't put passwords in your will.** Wills become public documents at probate. Keep credentials in a separate, secure document, a dedicated password manager with emergency access, or a sealed envelope held by your solicitor.
:::
...
- q: Does Facebook delete accounts automatically after death?
  a: No. Without action, a Facebook account simply remains. A nominated legacy contact can memorialise it, or a verified family member can request deletion. Facebook will not act without formal notification.
:::
